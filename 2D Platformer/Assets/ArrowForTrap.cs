...
public class ArrowForTrap : MonoBehaviour
{
    [SerializeField]
    ...
    {
        if ((whatIsWall & 1 << collision.gameObject.layer) == 1 << collision.gameObject.layer)
        {
        ...
        if ((whatIsPlayer & 1 << collision.gameObject.layer) == 1 << collision.gameObject.layer)
        {
