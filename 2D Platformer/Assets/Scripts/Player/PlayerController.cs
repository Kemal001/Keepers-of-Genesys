...
public class PlayerController : MonoBehaviour
{
    ...
    private void CheckSurroundings()
    {
        ...
        isTouchingEnemy = Physics2D.OverlapCircle(enemyCheck.position, enemyCheckRadius, whatIsEnemy);
    ...
    {
        if(isFasingRight && movementInputDirection < 0)
        {
            Flip();
        }
        else if(!isFasingRight && movementInputDirection > 0)
        {
            Flip();
        }
    ...
    private void UpdateAnimations()
    {
        ...
        animator.SetBool("SprintRun", sprintRunning);
    ...
    private void CheckInput()
    {
        ...
        if(Input.GetButtonDown("Jump"))
        {
            ...
            {
                NormalJump();
                AudioManager.instance.Play("First Jump");
            }
            else
            {
